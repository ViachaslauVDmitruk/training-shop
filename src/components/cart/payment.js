        ...
        <div className="choose-method">
          ...
          <div className="choose-method__radio">
            <label htmlFor="choise_1" className="radio-button">
              <Field type="radio" id="choise_1" name="paymentMethod" className="choose-method__item" value="PayPal" />
          ...
          <div className="choose-method__radio">
            <label htmlFor="choise_4" className="radio-button">
              <Field type="radio" id="choise_4" name="paymentMethod" className="choose-method__item" value="Cash" />
              ...
              <div className="choose-info__item house">
                <div className="choose-info-house">
                  <Field
                    ...
                    mask={'99/99'}
                    style={
                      props.formik.touched.cardDate && !props.formik.values.cardData
                        ? { border: '1px solid red' }
                        : { border: 'none' }
                    }
                  />
                ...
                <div className="choose-info-house">
                  <Field
                    ...
                    // mask={"999"}
                    style={
                      props.formik.touched.cardCVV && !props.formik.values.cardCVV ? { border: '1px solid red' } : null
                    }
                  />
